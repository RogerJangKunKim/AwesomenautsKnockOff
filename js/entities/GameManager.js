...
game.SpendGold = Object.extend({
	...
	checkCost: function(skill){
		...
		else if(skill === 3 && (game.data.gold >= ((game.data.skill3 + 1)*10))){ //if i have enough money to buy the skill, then returns true
			return true;
		}
		else if(skill === 4 && (game.data.gold >= ((game.data.ability1 + 1)*10))){ //if i have enough money to buy the skill, then returns true
			return true;
		}
		else if(skill === 5 && (game.data.gold >= ((game.data.ability2 + 1)*10))){ //if i have enough money to buy the skill, then returns true
			return true;
		}
		else if(skill === 6 && (game.data.gold >= ((game.data.ability3 + 1)*10))){ //if i have enough money to buy the skill, then returns true
			return true;
		}
		else{
			return false;
	...
	makePurchase: function(skill){
		if(skill === 1){ //executes if the skill level is 1
